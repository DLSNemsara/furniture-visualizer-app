  ...
  return (
    <Stack spacing={8}>
      ...
      >
        {/* Landing Image Big 1 */}
        <Image
          src={`/media/homepageimages/homepageimage3.jpg`}
          alt="Landing Image"
          objectFit="cover"
          w={{ base: "100%", md: "60%" }}
          h={{ base: "60vh", md: "auto" }}
        ...
        <Box position="relative" w={{ base: "100%", md: "40%" }} bg="gray.200">
          ...
          <Image
            src="/media/homepageimages/homepageimage-small-3.jpg"
            alt="Landing Image"
            objectFit="cover"
            w="100%"
            h={{ base: "70vh", md: "100%" }}
          ...
          >
            ...
            >
              Buy Furniture Online In <br /> Furnique At Your Leisure
            </Heading>
            <Text
        ...
        <Box position="relative" w={{ base: "100%", md: "40%" }} bg="gray.200">
          ...
          >
            ...
            <Text
              ...
              color="gray.700"
            >
              Find your ideal sofa online at Furnique.
            </Text>
            <Button
              as={Link}
              to="/store/sofas"
      ...
      >
        ...
        <Text>Open 9am to 6pm daily, including Public Holidays</Text>
